            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  onChange={handleInputChange}
                  className={`w-full bg-white p-4 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 resize-y min-h-[120px] text-gray-900 ${
                    errors.message
                      ? "border-red-300"
                      : "border-slate-200 hover:border-emerald-300"
                  }`}
