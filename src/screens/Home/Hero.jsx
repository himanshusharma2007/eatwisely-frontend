      ...
      <div className="relative z-10 container mx-auto px-6 py-12 text-center max-w-6xl">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            healthier choices for you and your family. Your journey to better
          ...
          >
  <button
    className="group relative bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-xl hover:shadow-2xl transform cursor-pointer transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden"
    onClick={() => navigate('/scan')}
  >
    {/* Wave animation overlay */}
    <div className="absolute inset-0 bg-gradient-to-r from-white/20 via-white/40 to-emerald-300/60 opacity-0 transform -translate-x-full skew-x-12 group-hover:translate-x-full group-hover:opacity-100 transition-all duration-1000 ease-in-out"></div>
    
    {/* Shimmer effect */}
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 transform -translate-x-full group-hover:translate-x-full group-hover:opacity-100 transition-all duration-800 ease-out delay-100"></div>
